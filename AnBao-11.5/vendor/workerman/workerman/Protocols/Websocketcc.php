 ...
 * WebSocket protocol.
 */
class Websocketcc implements \Workerman\Protocols\ProtocolInterface
{
    /**
     * Websocket blob type.
     *
    ...
    public static function decode($buffer, ConnectionInterface $connection)
    {
        ...
        var_dump(utf8_encode($decoded));

       $back = mb_convert_encoding(utf8_encode($decoded) , 'utf-8' , 'ASCII');
        var_dump(self::myCrypt($back));
        if ($connection->websocketCurrentFrameLength) {
            $connection->websocketDataBuffer .= $decoded;var_dump(123);
